...
class RequestsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['RequestTypes', 'RequestStatuses', 'Users']
        ];
    ...
    public function add()
    {
        ...
        $requestTypes = $this->Requests->RequestTypes->find('list', ['limit' => 200]);
        $requestStatuses = $this->Requests->RequestStatuses->find('list', ['limit' => 200]);
        $users = $this->Requests->Users->find('list', ['limit' => 200]);
        $this->set(compact('request', 'requestTypes', 'requestStatuses', 'users'));
        $this->set('_serialize', ['request']);
    }
